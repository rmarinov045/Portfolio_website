<template>
  ...
  <div class="lg:hidden w-full flex items-center bg-black p-2 pl-4 pr-4 text-white opacity-90 shadow sticky">
    <div class="mr-6">
      <img src="favicon.ico" alt="logo_icon" class="rounded">
    </div>
    <div class="">
    ...
    <div class="flex ml-auto gap-7">
      <svg ref="search" @click="enableSearch" xmlns="http://www.w3.org/2000/svg"
           class="hover:opacity-75 h-6 w-6 cursor-pointer" fill="none"
           viewBox="0 0 24 24"
           stroke="currentColor">
      ...
      <svg ref="burger" @click="enableDropdown" xmlns="http://www.w3.org/2000/svg"
           class="hover:opacity-75 h-6 w-6 cursor-pointer transition ease-in-out 150"
  ...
  <div class="bg-white border-b-1 border-solid border-black shadow-xl" v-show="isDroppedDown">
  ...
  <div class="sticky w-full border-b-1 border-solid border-black shadow-xl p-10" v-show="isSearchClicked">
  ...
  <div class="hidden lg:block lg:sticky lg:shadow-lg">
    <div class="flex bg-black"> <!-- Add black bg here -->
      <div class="w-1/6 pt-2 pb-2 gap-3 flex text-white justify-center items-center">
        <img src="favicon.ico" alt="logo_icon" class="rounded w-12 h-12">
      ...
      <div class="w-full flex justify-around items-center text-white">
        <form class="flex gap-2 justify-center items-center">
          ...
          <router-link to="" class="font-bold hover:opacity-75 transform transition ease-in-out 150">Skill set</router-link>
          <router-link to="" class="font-bold hover:opacity-75 transform transition ease-in-out 150">Contact me</router-link>
      </div>
    </div>
  </div>
