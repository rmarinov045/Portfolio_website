  ...
  <div class="to-do h-full flex-grow">
    ...
    <div class="lg:block hidden w-full h-full p-4">
      ...
      <div class="w-full h-full rounded-xl mt-10 p-2 pl-4 pr-4">
        ...
        <p class="mt-96">... more advanced version coming soon!</p>
  ...
  methods: {
    toggleAddTask() {
      ...
      if (this.isAddTaskClicked) {
        ...
        document.getElementById('name-input-big').classList.remove('border-red-500')
        document.getElementById('place-input-big').classList.remove('border-red-500')
      } else {
    ...
    addTask(name, place, description) {
      ...
      if (name.length || place.length === 0) {
        if (name.length === 0 && place.length === 0) {
          ...
          document.getElementById('name-input-big').classList.add('border-red-500')
          document.getElementById('place-input-big').classList.add('border-red-500')
          return
